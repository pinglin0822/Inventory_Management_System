...
<div class="col-lg-7">
    <div class="card shadow-lg border-0 rounded-lg mt-5">
        <div class="card-header"><h3 class="text-center font-weight-light my-4">Edit Post</h3></div>
        <div class="card-body">
            <form method="POST" action="{{ route('editpost', ['id' => $posts->id]) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                    <div class="form-row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control py-4" name="user_id" id="user_id" type="text" value="{{$posts->user_id}}"/>
                        </div>
                    </div> 
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="small mb-1" for="title">Title</label>
                            <input class="form-control py-4" name="title" id="title" type="text" value="{{$posts->title}}"/>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="small mb-1" for="content">Content</label>
                            <input class="form-control py-4" name="content" id="content" type="text" value="{{$posts->content}}"/>
                        </div>
                    </div>
                </div>
